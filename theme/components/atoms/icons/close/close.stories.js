...
export const Basic = {
  args: {
    ...
    hoverBackgroundPaletteColour: 'var(--colour-error)',
    hoverBackgroundCustomColour: '#b10e1e',

    hoverBorderColourSource: 'palette',
    hoverBorderPaletteColour: 'var(--colour-error)',
    hoverBorderCustomColour: '#b10e1e',
  },
