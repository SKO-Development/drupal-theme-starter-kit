...
<svg
  ...
  aria-hidden="true"
>
  <path d="M10.3 4.3 2.5 18a2 2 0 0 0 1.7 3h15.6a2 2 0 0 0 1.7-3L13.7 4.3a2 2 0 0 0-3.4 0Z"></path>
  <path d="M12 9v4"></path>
...
export const Basic = {
  args: {
    ...
    iconPaletteColour: 'var(--colour-warning)',
    iconCustomColour: '#f5a623',
    ...
    hoverIconPaletteColour: 'var(--colour-black)',
    hoverIconCustomColour: '#000000',

    hoverBackgroundColourSource: 'palette',
    hoverBackgroundPaletteColour: 'var(--colour-warning)',
    hoverBackgroundCustomColour: '#f5a623',

    hoverBorderColourSource: 'palette',
    hoverBorderPaletteColour: 'var(--colour-warning)',
    hoverBorderCustomColour: '#f5a623',
  },
  ...
  render: args => `
    <div style="padding: 2rem;">
      <button
        type="button"
        aria-label="View warning information"
        style="
          display: inline-flex;
          padding: 0;
          border: 0;
