...
export default {
  title: 'Atoms/Icons/Chevron Down',
...
export const Basic = {
  args: {
    ...
    iconPaletteColour: 'var(--colour-success)',
    iconCustomColour: '#00703c',
    ...
    hoverBackgroundPaletteColour: 'var(--colour-success)',
    hoverBackgroundCustomColour: '#00703c',

    hoverBorderColourSource: 'none',
    hoverBorderPaletteColour: 'var(--colour-success)',
    hoverBorderCustomColour: '#00703c',
  },
